...
const Reports = () => {
  ...
  const downloadReport = () => {
    ...
    lines.push(`Business balance: ${money(walletStats.balance)}`);
    lines.push(`Sales revenue: ${money(periodStats.revenue)}`);
